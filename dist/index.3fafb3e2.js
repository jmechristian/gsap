...
},{"./data":"4AbXi","gsap":"1iecp","gsap/ScrollTrigger":"5s7rm","smooth-scrollbar":"613xV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4AbXi":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "data", function () {
  return data;
});
const data = [{
  id: 1,
  imageSrc: "https://images.unsplash.com/photo-1616788373791-1d4794500268?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80"
}, {
  id: 2,
  imageSrc: "https://images.unsplash.com/photo-1594739297262-188737d3c2b7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=964&q=80"
}, {
  id: 3,
  imageSrc: "https://images.unsplash.com/photo-1618938225889-a87f84263cc8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80"
}, {
  id: 4,
  imageSrc: "https://images.unsplash.com/photo-1556483563-7f4034a4eeb0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2250&q=80"
}, {
  id: 5,
  imageSrc: "https://images.unsplash.com/photo-1590735213920-68192a487bc2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80"
}, {
  id: 6,
  imageSrc: "https://images.unsplash.com/photo-1616149562385-1d84e79478bb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2250&q=80"
}];
...
},{}],"5s7rm":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "ScrollTrigger", function () {
...
_revertRecorded = function _revertRecorded(media) {
  ...
  if (state) {
    ...
    // otherwise transforms may be off
    for (; i < l; i += 2) {
      value = state[i + 1];
      p = state[i];
      if (value) {
...
_getTweenCreator = function _getTweenCreator(scroller, direction) {
  ...
  lastScroll1, lastScroll2, getTween = function getTween(scrollTo, vars, initialValue, change1, change2) {
    ...
    modifiers[prop] = function (value) {
      ...
      // round because in some [very uncommon] Windows environments, it can get reported with decimals even though it was set without.
  ...
  _proto.init = function init(vars, animation) {
    ...
    self.refresh = function (soft, force) {
      ...
      while (i--) {
        ...
        // if it's a timeline-based trigger that hasn't been fully initialized yet because it's waiting for 1 tick, just force the refresh() here, otherwise if it contains a pin that's supposed to affect other ScrollTriggers further down the page, they won't be adjusted properly.
      ...
      if (pin) {
        ...
        if (animation) {
          ...
          // if not, we must invalidate() after this step, otherwise it could lock in starting values prematurely.
      ...
      // must force a re-render because if saveStyles() was used on the target(s), the styles could have been wiped out during the refresh().
  ...
  ScrollTrigger.register = function register(core) {
    if (!_coreInitted) {
      ...
      if (gsap) {
        ...
        // must register the global manually because in Internet Explorer, functions (classes) don't have a "name" property.
        if (_body) {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"613xV":[function(require,module,exports) {
var define;
!(function (t, e) {
  ...
  return (function (t) {
    ...
    ******************************************************************************/
    ...
    function ct(t) {
      var e, n = F(t), r = t.containerEl, o = t.contentEl, i = t.offset, u = t.limit, c = !1;
...
},{}]},["3Imd1","5rkFb"], "5rkFb", "parcelRequire420d")
